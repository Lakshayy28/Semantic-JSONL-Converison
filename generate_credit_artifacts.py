...
def generate_word_doc():
    ...
    doc.add_paragraph('By migrating to a dedicated microservice, the business aims to achieve a '
                      ...
                      'This underwriting engine is core to our credit line increase strategy during the new '
                      'financial year.')
...
def generate_excel():
    ...
    # 8 endpoints for the DecisionController
    endpoints = [
...
if __name__ == "__main__":
    ...
    generate_markdown()
    generate_excel()
    print("All comprehensive artifacts for Credit Decisioning correctly generated.")